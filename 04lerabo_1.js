...
window.addEventListener('DOMContentLoaded', () => {
    kakao.maps.load(() => {
            ...
            <div class="customOverlay" style="background:#CFCFC9; padding:10px; border:1px solid #aaa; border-radius:8px; box-shadow:0 2px 6px rgba(0,0,0,0.3); position:relative; display:flex; align-items:center; gap:8px;">
                ...
                <div style="font-size:1.4rem;">
                    <div style="position:relative; height:auto;">
                        <div style='font-weight:bold; font-size:1.6rem;'>LE LABO 플래그쉽 스토어</div>
        ...
        const overlay = new kakao.maps.CustomOverlay({
            ...
            position: new kakao.maps.LatLng(leraboPosition.getLat() + 0.0005, leraboPosition.getLng()),
            yAnchor: 1
        });
        overlay.setMap(map);

        document.querySelector('.leraboMap .customOverlay .close-btn')
...
function placesSearchCB(data, status){
    ...
    const destination = `${leraboPosition.getLng()},${leraboPosition.getLat()}`;
